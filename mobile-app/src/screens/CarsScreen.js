                        ...
                        <TouchableWithoutFeedback key={"index" + i} onPress={() => onPress(c)}>
                            <View style={styles.card}>
                                ...
                                <View style={[styles.vew1,{backgroundColor: MAIN_COLOR, flexDirection: isRTL ? 'row-reverse' : 'row', borderBottomRightRadius: isRTL ? null : 90, borderBottomLeftRadius:  isRTL ? 90 : null}]}>
                                    <View style={{flexDirection:isRTL? 'row-reverse':'row', justifyContent: 'center', width: width-20}}>
                                ...
                                <View style={[styles.vew, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
                                    <MaterialCommunityIcons name="car-multiple" size={24} color={colors.SKY} style={styles.icon} />
                                    <View>
                                ...
                                <View style={[styles.vew, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
                                    <MaterialCommunityIcons name="numeric" size={24} color={colors.SKY} style={styles.icon} />
                                    <View>
                                        <Text style={styles.text1}>{t('vehicle_reg_no')}</Text>
                                        <Text style={[styles.text1,{fontWeight:'bold'}]}>{c.vehicleNumber}</Text>
                                    </View>

                                </View>

                                <View style={[styles.vew, { flexDirection: isRTL ? 'row-reverse' : 'row',marginBottom:10}]}>
                                    <Entypo name="info" size={24} color={colors.SKY} style={styles.icon} />
                                    <View>
                                        <Text style={styles.text1}>{t('other_info')}</Text>
                                        <Text style={[styles.text1,{fontWeight:'bold'}]}>{c.other_info}</Text>
                                    </View>
