            ...
            >
              {paramData ? (
                !(
                  ...
                  paramData.driver_image == null ||
                  paramData.driver_image == "undefined"
                ) ? (
                  <Avatar
                    size="small"
                    rounded
                ...
                {paramData && paramData.rating > 0 ? (
                  <View style={[styles.personTextView]}>
                    <Text
                      style={[
                        styles.ratingText,
                        isRTL ? { marginLeft: 18 } : { marginRight: 8 },
                      ]}
                    >
                      {t("you_rated_text")}
                    </Text>
                    <StarRating
                      ...
                      style={[
                        styles.contStyle,
                        isRTL ? { marginRight: 80 } : { marginLeft: -5 },
                      ]}
                      onChange={() => {
                        //console.log('hello')
                      }}
                  ...
                  {settings.swipe_symbol === false ? (
                    ...
                    >
                      ...
                      {paramData && paramData.trip_cost > 0
                        ...
                        : paramData && paramData.estimate
                        ? parseFloat(paramData.estimate).toFixed(
                            settings.decimal
                          )
                        : 0}
                    </Text>
                  ...
                  {settings.swipe_symbol === false ? (
                    ...
                    >
                      ...
                      {paramData && paramData.discount
                        ? parseFloat(paramData.discount).toFixed(
                            settings.decimal
                          )
                        : 0}{" "}
                      {isRTL ? "-" : null}
