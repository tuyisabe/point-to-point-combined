...
export const MAIN_COLOR = colors.BUTTON_YELLOW;
...
export const CarVertical = (props) =>{
    ...
    return (
        <TouchableOpacity
            style={[styles.carContainer, { backgroundColor: carData.active == true ? colors.BOX_BG : colors.WHITE,flexDirection: isRTL?'row-reverse':'row',}]}
            onPress={onPress}
        >
            <Image
